...
index_line = 3
# over in 6
data_0 = txt_read('lines_fm_0.95_2020-05-07-18-59-58.txt')
data_1 = txt_read('lines2020-05-06-17-30-13.txt')

y0 = smooth([float(i) for i in data_0[index_line]], weight=0.5)
y1 = smooth([float(i) for i in data_1[index_line]], weight=0.5)
...
# # over in txt
ax1.plot([float(i) for i in range(len_test)], y0, label='GCC')
ax1.plot([float(i) for i in range(len_test)], y1, label='CNN+GRU')
